...
public class MetaDataTest {
    ...
    void testDatabaseMetaData() throws SQLException {
        ...
        ResultSet resultSet = databaseMetaData.getTables("iegcode_java_database", null, null, null);
    ...
    @Test // seputar informasi parameter
    void testParameterMetaData() throws SQLException {
        ...
        // System.out.println(parameterMetaData.getParameterTypeName(1)); err

        preparedStatement.close();
        connection.close();
    }

    @Test // seputar informaasi hasil ResultSet
